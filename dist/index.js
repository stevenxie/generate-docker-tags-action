...
const push_1 = __webpack_require__(700);
const pull_request_1 = __webpack_require__(843);
const getTags = () => {
    const eventName = process.env.GITHUB_EVENT_NAME;
    core_1.debug(`Got event: ${eventName}`);
    switch (eventName) {
        case "push":
            return push_1.getPushTags();
        case "pull_request":
            return pull_request_1.getPullRequestTags();
        default:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getPullRequestTags = void 0;
exports.getPullRequestTags = () => {
